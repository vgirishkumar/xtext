...
import org.eclipse.xtext.generator.trace.Location;
import org.eclipse.xtext.generator.trace.Region;
...
public class TraceRegionToStringTest {
  ...
  public void simple() {
    ...
    _builder.newLine();
    tester.setLocal(_builder.toString());
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("baz buz");
    _builder_1.newLine();
    tester.setRemote1(_builder_1.toString());
    URI _uri1 = tester.getUri1();
    Location _location = new Location(4, 2, _uri1);
    Region _region = new Region(1, 2, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
  ...
  public void oneChild() {
    ...
    tester.setRemote1(_builder_1.toString());
    URI _uri1 = tester.getUri1();
    Location _location = new Location(1, 6, _uri1);
    Region _region = new Region(0, 7, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
    final Procedure1<Region> _function = new Procedure1<Region>() {
      @Override
      public void apply(final Region it) {
        Location _location = new Location(2, 4);
        it.addChild(1, 6, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
      }
    };
    Region _doubleArrow = ObjectExtensions.<Region>operator_doubleArrow(_region, _function);
  ...
  public void twoIdentical() {
    ...
    tester.setRemote1(_builder_1.toString());
    URI _uri1 = tester.getUri1();
    Location _location = new Location(1, 5, _uri1);
    Region _region = new Region(0, 7, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
    final Procedure1<Region> _function = new Procedure1<Region>() {
      @Override
      public void apply(final Region it) {
        Location _location = new Location(1, 5);
  ...
  public void twoFrame1() {
    ...
    final Procedure1<Region> _function = new Procedure1<Region>() {
      ...
      public void apply(final Region it) {
        ...
        Location _location_1 = new Location(1, 5);
  ...
  public void twoFiles() {
    ...
    URI _uri1 = tester.getUri1();
    Location _location = new Location(0, 7, _uri1);
    Region _region = new Region(0, 7, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
    final Procedure1<Region> _function = new Procedure1<Region>() {
      @Override
      public void apply(final Region it) {
        Location _location = new Location(0, 3);
        it.addChild(0, 3, Collections.<ILocationData>unmodifiableList(CollectionLiterals.<ILocationData>newArrayList(_location)));
        URI _uri2 = tester.getUri2();
        Location _location_1 = new Location(0, 3, _uri2);
